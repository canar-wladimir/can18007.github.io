var byuObjet = new XMLHttpRequest();
byuObjet.open('GET', 'https://byui-cit230.github.io/weather/data/towndata.json',true);
/*byuObjet.open('GET', '//byui-cit230.github.io/weather/data/towndata.json',true);*/

byuObjet.send();
byuObjet.onload = function() {
    var byuInfo = JSON.parse(byuObjet.responseText);
    /*console.log(byuInfo);*/
    document.getElementById('name').innerHTML = byuInfo.towns[0].name + "<br>Perston City";
    ...
    document.getElementById('name2').innerHTML = byuInfo.towns[2].name + "<br>Fishaven City";
    ...
    document.getElementById('name3').innerHTML = byuInfo.towns[6].name + "<br>Sodaspring City";
